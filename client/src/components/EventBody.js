...
export default function EventBody(props) {
    ...
    return (
        <div className="eventDetails">
            <h5>{props.displayState.event.label_1}</h5>
            <h5>{props.displayState.event.label_2}</h5>
            <h5>{props.displayState.event.label_3}</h5>
            <h5>{props.displayState.event.label_4}</h5>
